...
namespace Devdraft\Core;

use Devdraft\Core\Contracts\BasePage;
use Devdraft\Core\Contracts\BaseResponse;
use Devdraft\Core\Contracts\BaseStream;
...
use Devdraft\Core\Implementation\RawResponse;
...
abstract class BaseClient
{
    ...
    /** @return array<string,string> */
    abstract protected function xClientKey(): array;

    /** @return array<string,string> */
    abstract protected function xClientSecret(): array;

    /** @return array<string,string> */
    abstract protected function idempotencyKeyScheme(): array;
